...
for v in 0 1 2 3 4 5 6 ;
    do let secs=$t*48*3+500 && \
       ...
       qsub -l h_rt=$time submit_anytime_tree_search.sh $HOME/Scratch/results/${date}_208/guided_${tree_search_func_name}/g${g}_v${v}/g${g}_t${t}_p${rho}_${heuristic_method}_e${epoch} \
