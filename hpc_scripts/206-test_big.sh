  ...
  do for t in 60;
    do for heuristic_method in "advanced_priority_list";
      do let secs=$t*48*3+500 && \
         ...
         qsub -l h_rt=$time submit_anytime_tree_search.sh $HOME/Scratch/results/${date}_205/guided_${tree_search_func_name}/g${g}/g${g}_t${t}_p${rho}_${heuristic_method}_e${epoch} \
