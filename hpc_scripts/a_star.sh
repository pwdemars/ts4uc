...
qsub -l h_rt=1:00:00 test_tree_search.sh $HOME/Scratch/results/${date}/unguided_astar/g5/h2 none $HOME/AISO_HPC/mar14/5_env_params.json none 2 -1 a_star $HOME/AISO_HPC/AISO/input_g5_d30.txt
...
qsub -l h_rt=1:00:00 test_tree_search.sh $HOME/Scratch/results/${date}/unguided_rtastar/g5/h2 none $HOME/AISO_HPC/mar14/5_env_params.json none 2 -1 rta_star $HOME/AISO_HPC/AISO/input_g5_d30.txt
