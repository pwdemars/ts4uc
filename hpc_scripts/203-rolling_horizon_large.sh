  ...
  do for t in 60;
    do for heuristic_method in "advanced_priority_list";
      do let secs=$t*48*3+100 && \
         ...
         qsub -l h_rt=$time submit_rolling_tree_search_scenarios.sh $HOME/Scratch/results/${date}_203/rolling_guided_${tree_search_func_name}/g${g}/g${g}_t${t}_p${rho}_${heuristic_method} \
